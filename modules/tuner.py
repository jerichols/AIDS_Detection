...
from modules.transform import CATEGORICAL_FEATURES, LABEL_KEY, NUMERICAL_FEATURES, transformed_name
...
def gzip_reader_fn(filenames):
    ...
    Returns:
        TFRecordDataset: Compressed data
    """
...
def get_model_tuner(hp):
    """This function defines hyperparameters to tune for the keras Model
